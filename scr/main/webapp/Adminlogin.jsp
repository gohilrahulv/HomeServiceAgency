	...
	<section class="middle-sec mt-5 mb-5">
		<form method="post" name="login" id="Loginform">
			<div class="border border-dark pb-5 pt-4 outer-border">
				...
				<label class="form-label mt-3 mx-2" id="AcTypeHeadline" style="display: none;"><span style="font-weight:500;">Account Type</span> <span style="color:red">* </span></label>
				
				<div class="form-check form-check-inline hidden-radio">
  					<input class="form-check-input" type="radio" name="AccountType" id="AdminAccount" value="Admin" checked>
